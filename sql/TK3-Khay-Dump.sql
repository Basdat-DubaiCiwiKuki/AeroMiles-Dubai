-- =================================================================
--  TK03 | Dump SQL — Group 4: Miles & Reward Management
--  Kelompok A-10
--  Nama File  : TK03_DUMP_SQL_A_10_group4.sql
--
--  Deskripsi:
--  File ini berisi implementasi tabel yang berkaitan dengan:
--    - Penyedia & Mitra (partner sistem)
--    - Reward / Hadiah
--    - Award Miles Package (pembelian miles)
--    - Transaksi pembelian package oleh member
--    - Transfer miles antar member
--    - Redeem hadiah oleh member
--
...
--    3. TK3-Abas-Dump.sql   → CLAIM_MISSING_MILES
--    4. TK3-Shafa-Dump.sql  → PENYEDIA, MITRA, HADIAH,
--                              AWARD_MILES_PACKAGE,
--                              MEMBER_AWARD_MILES_PACKAGE,
--                              TRANSFER, REDEEM  ← file ini
--
--  Dependencies tabel:
--    MEMBER   → digunakan pada:
--               MEMBER_AWARD_MILES_PACKAGE, TRANSFER, REDEEM
--    PENYEDIA → digunakan pada:
--               MITRA, HADIAH, MASKAPAI
--    HADIAH   → digunakan pada:
--               REDEEM
--    AWARD_MILES_PACKAGE → digunakan pada:
--               MEMBER_AWARD_MILES_PACKAGE
--
--  Catatan:
--    - Satu Member dapat membeli package berkali-kali (dibedakan timestamp)
--    - Transfer tidak boleh ke diri sendiri
--    - Redeem dan Transfer bersifat permanen (tidak dapat diubah/hapus)
--    - Penghapusan MITRA/PENYEDIA akan berdampak pada data terkait (cascade)
-- =================================================================
